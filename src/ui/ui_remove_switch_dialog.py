# Form implementation generated from reading ui file '/home/peach/Uni/mnGui/src/ui/remove_switch_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.dpid_name = QtWidgets.QLineEdit(Dialog)
        self.dpid_name.setEnabled(False)
        self.dpid_name.setObjectName("dpid_name")
        self.form_layout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.dpid_name)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Remove Switch"))
        self.host_label.setText(_translate("Dialog", "Switch Name"))
        self.mac_label.setText(_translate("Dialog", "DPID"))
